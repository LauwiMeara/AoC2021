...
namespace _11._2
{
    class Program
    {
        static void Main()
        {
            ...
            int numOctopuses = input.SelectMany(o => o).Count();
            bool synchronizedFlash = false;
            int steps = 0;
            ...
            while (!synchronizedFlash)
            {
                ...
                if (flashed.Count == numOctopuses) synchronizedFlash = true;
            }

            Console.WriteLine($"The first synchronized flash is at step {steps}");
        }
